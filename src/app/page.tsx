      ...
      <div className="w-full max-w-3xl bg-white rounded-xl shadow-2xl overflow-hidden mx-4">
        <div className="px-6 py-8">
          ...
          <div className="mb-6">
            ...
            <div className="flex rounded-md shadow-sm color">
              <input
                type="text"
                id="contract-address"
                ...
                className="flex-grow px-4 py-3 border border-gray-300 rounded-l-md focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 text-black"
              />
              <button
                onClick={fetchABI}
                disabled={isLoading}
